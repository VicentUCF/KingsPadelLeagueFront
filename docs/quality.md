...
CI (.github/workflows/ci.yml)
  → static-checks: format:check, lint, typecheck, knip, architecture
...
(`no-floating-promises`), y cualquier `eslint-disable` sin una razón (`-- motivo`) tras `--`. Como
**warning**: comentarios `TODO`/`FIXME`/`HACK`.
